...
public class WorkspaceStateTransitionAnimation {
    ...
    private void animateWorkspace(final TransitionStates states, final boolean animated,
        ...
        float finalHotseatAlpha = (states.stateIsNormal || states.stateIsSpringLoaded ||
                (FeatureFlags.max_launcher_ALL_APPS_PULL_UP && states.stateIsNormalHidden)) ? 1f : 0f;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (states.stateIsOverviewHidden) {
                ...
                finalAlpha = (FeatureFlags.max_launcher_ALL_APPS_PULL_UP &&
            ...
            // current page in
            if (!FeatureFlags.max_launcher_ALL_APPS_PULL_UP && !mWorkspace.isSwitchingState()) {
