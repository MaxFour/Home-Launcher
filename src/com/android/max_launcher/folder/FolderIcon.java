...
package com.android.max_launcher.folder;
...
import com.android.max_launcher.Alarm;
import com.android.max_launcher.AppInfo;
import com.android.max_launcher.BubbleTextView;
import com.android.max_launcher.CellLayout;
import com.android.max_launcher.CheckLongPressHelper;
import com.android.max_launcher.DeviceProfile;
import com.android.max_launcher.DropTarget.DragObject;
import com.android.max_launcher.FastBitmapDrawable;
import com.android.max_launcher.FolderInfo;
import com.android.max_launcher.FolderInfo.FolderListener;
...
import com.android.max_launcher.OnAlarmListener;
import com.android.max_launcher.R;
import com.android.max_launcher.ShortcutInfo;
import com.android.max_launcher.SimpleOnStylusPressListener;
import com.android.max_launcher.StylusEventHelper;
import com.android.max_launcher.Utilities;
import com.android.max_launcher.Workspace;
import com.android.max_launcher.badge.BadgeRenderer;
...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    public static final int NUM_ITEMS_IN_PREVIEW = FeatureFlags.max_launcher_LEGACY_FOLDER_ICON ?
    ...
    private void init() {
        ...
        mPreviewLayoutRule = FeatureFlags.max_launcher_LEGACY_FOLDER_ICON ?
    ...
    private void updateItemDrawingParams(boolean animate) {
        ...
        for (int i = 0; i < mDrawingParams.size(); i++) {
            ...
            if (!animate || FeatureFlags.max_launcher_LEGACY_FOLDER_ICON) {
