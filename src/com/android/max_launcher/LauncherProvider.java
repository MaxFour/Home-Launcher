...
import com.android.max_launcher.graphics.IconShapeOverride;
...
import com.android.max_launcher.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    /**
     * $ adb shell dumpsys activity provider com.android.max_launcher
     */
    @Override
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                // The version cannot be lower that 12, as max_launcher never supported a lower
                // version of the DB.
                case 12: {
