...
import com.android.max_launcher.DropTarget.DragObject;
import com.android.max_launcher.LauncherSettings.Favorites;
import com.android.max_launcher.accessibility.LauncherAccessibilityDelegate;
import com.android.max_launcher.allapps.AllAppsContainerView;
import com.android.max_launcher.allapps.AllAppsTransitionController;
import com.android.max_launcher.allapps.DefaultAppSearchController;
import com.android.max_launcher.anim.AnimationLayerSet;
import com.android.max_launcher.compat.AppWidgetManagerCompat;
import com.android.max_launcher.compat.LauncherAppsCompat;
import com.android.max_launcher.compat.PinItemRequestCompat;
import com.android.max_launcher.config.FeatureFlags;
import com.android.max_launcher.config.ProviderConfig;
import com.android.max_launcher.dragndrop.DragController;
import com.android.max_launcher.dragndrop.DragLayer;
import com.android.max_launcher.dragndrop.DragOptions;
import com.android.max_launcher.dragndrop.DragView;
import com.android.max_launcher.dragndrop.PinItemDragListener;
import com.android.max_launcher.dynamicui.ExtractedColors;
import com.android.max_launcher.folder.Folder;
import com.android.max_launcher.folder.FolderIcon;
import com.android.max_launcher.keyboard.CustomActionsPopup;
import com.android.max_launcher.keyboard.ViewGroupFocusHelper;
import com.android.max_launcher.logging.FileLog;
import com.android.max_launcher.logging.UserEventDispatcher;
import com.android.max_launcher.model.ModelWriter;
import com.android.max_launcher.model.PackageItemInfo;
import com.android.max_launcher.model.WidgetItem;
import com.android.max_launcher.notification.NotificationListener;
import com.android.max_launcher.pageindicators.PageIndicator;
import com.android.max_launcher.popup.PopupContainerWithArrow;
import com.android.max_launcher.popup.PopupDataProvider;
import com.android.max_launcher.shortcuts.DeepShortcutManager;
import com.android.max_launcher.shortcuts.ShortcutKey;
import com.android.max_launcher.userevent.nano.LauncherLogProto;
import com.android.max_launcher.userevent.nano.LauncherLogProto.Action;
import com.android.max_launcher.userevent.nano.LauncherLogProto.ContainerType;
import com.android.max_launcher.userevent.nano.LauncherLogProto.ControlType;
import com.android.max_launcher.util.ActivityResultInfo;
import com.android.max_launcher.util.ComponentKey;
import com.android.max_launcher.util.ItemInfoMatcher;
import com.android.max_launcher.util.MultiHashMap;
import com.android.max_launcher.util.PackageManagerHelper;
import com.android.max_launcher.util.PackageUserKey;
import com.android.max_launcher.util.PendingRequestArgs;
import com.android.max_launcher.util.TestingUtils;
import com.android.max_launcher.util.Thunk;
import com.android.max_launcher.util.ViewOnDrawExecutor;
import com.android.max_launcher.widget.PendingAddShortcutInfo;
import com.android.max_launcher.widget.PendingAddWidgetInfo;
import com.android.max_launcher.widget.WidgetAddFlowHandler;
import com.android.max_launcher.widget.WidgetHostViewLoader;
import com.android.max_launcher.widget.WidgetsContainerView;
...
public class Launcher extends BaseActivity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.android.max_launcher.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    private void setupViews() {
        ...
        if (FeatureFlags.max_launcher_ALL_APPS_PULL_UP) {
    ...
    public void onClick(View v) {
        ...
        } else if ((FeatureFlags.max_launcher_ALL_APPS_PULL_UP && v instanceof PageIndicator) ||
    ...
    public boolean onLongClick(View v) {
        ...
        if ((FeatureFlags.max_launcher_ALL_APPS_PULL_UP && v instanceof PageIndicator) ||
                (v == mAllAppsButton && mAllAppsButton != null)) {
    ...
    private void updateSoftInputMode() {
        if (FeatureFlags.max_launcher_UPDATE_SOFT_INPUT_MODE) {
            final int mode;
            if (isAppsViewVisible()) {
    ...
    /**
     * $ adb shell dumpsys activity com.android.max_launcher.Launcher [--all]
     */
    @Override
