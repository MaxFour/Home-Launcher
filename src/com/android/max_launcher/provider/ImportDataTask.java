...
package com.android.max_launcher.provider;
...
import com.android.max_launcher.AutoInstallsLayout.LayoutParserCallback;
import com.android.max_launcher.DefaultLayoutParser;
import com.android.max_launcher.LauncherAppState;
import com.android.max_launcher.LauncherAppWidgetInfo;
import com.android.max_launcher.LauncherFiles;
import com.android.max_launcher.LauncherSettings;
import com.android.max_launcher.LauncherSettings.Favorites;
import com.android.max_launcher.LauncherSettings.Settings;
import com.android.max_launcher.LauncherSettings.WorkspaceScreens;
...
/**
 * Utility class to import data from another Launcher which is based on max_launcher schema.
 */
public class ImportDataTask {
    ...
    private static final int getMyHotseatLayoutId(Context context) {
        if (LauncherAppState.getIDP(context).numHotseatIcons <= 5) return R.xml.dw_phone_hotseat;
        else {
