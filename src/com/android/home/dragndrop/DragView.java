...
import com.android.home.compat.ShortcutConfigActivityInfo;
...
public class DragView extends View {
    ...
    // Below variable only needed IF FeatureFlags.HOME_SPRING_ICONS is {@code true}
    ...
    public void setItemInfo(final ItemInfo info) {
        if (!(FeatureFlags.HOME_SPRING_ICONS && Utilities.ATLEAST_OREO)) {
            return;
        }
