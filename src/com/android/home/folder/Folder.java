...
import com.android.home.LogDecelerateInterpolator;
...
import com.android.home.pageindicators.PageIndicatorDots;
...
public class Folder extends AbstractFloatingView implements DragSource, View.OnClickListener,
    ...
    public void animateOpen() {
        ...
        AnimatorSet anim = FeatureFlags.HOME_NEW_FOLDER_ANIMATION
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            @Override
            public void onAnimationStart(Animator animation) {
                if (FeatureFlags.HOME_NEW_FOLDER_ANIMATION) {
    ...
    private void animateClosed() {
        AnimatorSet a = FeatureFlags.HOME_NEW_FOLDER_ANIMATION
