...
import com.android.home.allapps.DefaultAppSearchController;
...
import com.android.home.compat.PinItemRequestCompat;
...
public class Launcher extends BaseActivity
    ...
    private void setupViews() {
        ...
        if (FeatureFlags.HOME_ALL_APPS_PULL_UP) {
    ...
    public void onClick(View v) {
        ...
        } else if ((FeatureFlags.HOME_ALL_APPS_PULL_UP && v instanceof PageIndicator) ||
    ...
    public boolean onLongClick(View v) {
        ...
        if ((FeatureFlags.HOME_ALL_APPS_PULL_UP && v instanceof PageIndicator) ||
                (v == mAllAppsButton && mAllAppsButton != null)) {
