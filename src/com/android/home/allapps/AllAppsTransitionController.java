...
import com.android.home.anim.SpringAnimationHandler;
import com.android.home.config.FeatureFlags;
import com.android.home.graphics.GradientView;
...
public class AllAppsTransitionController implements TouchController, SwipeDetector.Listener,
    ...
    public void preparePull(boolean start) {
        if (start) {
            ...
            if (!mLauncher.isAllAppsVisible()) {
                ...
                if (!FeatureFlags.HOME_GRADIENT_ALL_APPS) {
    ...
    private void updateLightStatusBar(float shift) {
        ...
        boolean forceChange = FeatureFlags.HOME_GRADIENT_ALL_APPS ?
                shift <= mShiftRange / 4 :
    ...
    private boolean hasSpringAnimationHandler() {
        return FeatureFlags.HOME_PHYSICS && mSpringAnimationHandler != null;
    }
