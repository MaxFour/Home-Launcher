...
import com.android.home.AutoInstallsLayout.LayoutParserCallback;
import com.android.home.LauncherSettings.Favorites;
import com.android.home.LauncherSettings.WorkspaceScreens;
...
import com.android.home.graphics.IconShapeOverride;
import com.android.home.logging.FileLog;
import com.android.home.model.DbDowngradeHelper;
import com.android.home.provider.LauncherDbUtils;
import com.android.home.provider.LauncherDbUtils.SQLiteTransaction;
import com.android.home.provider.RestoreDbTask;
import com.android.home.util.ManagedProfileHeuristic;
import com.android.home.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    /**
     * $ adb shell dumpsys activity provider com.android.home
     */
    @Override
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                // The version cannot be lower that 12, as Home never supported a lower
                // version of the DB.
                case 12: {
